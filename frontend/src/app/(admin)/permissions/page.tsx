...
import { Shield, Users, Layers, Save, Lock, Briefcase, Plus, Edit3, Trash2, Check, X, Building2, Search, LogOut, Eye, History, RefreshCw } from "lucide-react";
...
type Tab = "matrix" | "admins" | "groups" | "positions" | "inspect" | "history";
  ...
  return (
    <div>
      ...
      <div className="flex gap-1 mb-6 bg-bg-secondary rounded-lg p-1 w-fit flex-wrap">
        ...
        <TabButton active={tab === "history"} onClick={() => setTab("history")} icon={History} label="변경 이력" />
      ...
      {tab === "positions" && <PositionTemplatesTab />}
      {tab === "inspect" && <UserInspectTab />}
      {tab === "history" && <PermissionAuditHistoryTab />}
      {tab === "admins" && <DesignatedAdminsTab />}
