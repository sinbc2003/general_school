...
/**
 * 학생용 단독 협업 스프레드시트 편집기 — course_id 없는 시트.
 *
 * /(admin)/sheets/[sid]/page.tsx 와 동일 SheetEditor + ShareDocModal 재사용.
 * 다른 점: 학생 layout 사용, "내 드라이브" 링크 → /s/drive.
 *
 * 권한 가드는 backend `_resolve_permission`이 access_mode/SheetMember 기반으로
 * 학생도 자동 처리. 페이지 자체는 admin과 동일 구조.
 */
...
export default function StudentStandaloneSheetPage() {
      ...
      <div className="flex-shrink-0 px-6 pt-5 pb-3">
        <div className="flex items-center justify-between gap-2 mb-2">
          ...
          <div className="flex items-center gap-2 text-caption text-text-tertiary flex-wrap">
            ...
            {canUseAI && sheet.permission.can_write && (
              <button
